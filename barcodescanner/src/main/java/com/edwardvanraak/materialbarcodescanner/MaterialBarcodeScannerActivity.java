...
public class MaterialBarcodeScannerActivity extends AppCompatActivity {
    ...
    private void setupLayout() {
        ...
        final TextView EnterIdTextView = (TextView) findViewById(R.id.tv_enterID);
        topTextView.setTypeface(tp);
        EnterIdTextView.setTypeface(tp);
        assertNotNull(topTextView);
        assertNotNull(EnterIdTextView);
